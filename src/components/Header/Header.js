...
export default function Header() {
  ...
  const svgPlus = <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-plus-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <nav className="navbar navbar-light bg-dark d-flex justify-content-center">
      ...
      <button type="button" class="btn btn-light ml-5">{svgPlus}</button>
    </nav>
  )
}